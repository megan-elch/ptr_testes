...
save(ppc_cor, file = "model_output/ppc_cor_prepped.RData")
rm(ppc_cor)
...
save(obs_cor, file = "model_output/obs_cor_prepped.RData")
load("model_output/ppc_cor_prepped.RData")
...
ggsave(plot = mp, filename = "figs_results/ppc_cor.pdf", width = 40, height = 25, units = "in", limitsize = F)
mp
```
